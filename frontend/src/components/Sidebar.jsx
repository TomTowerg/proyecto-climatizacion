...
function Sidebar() {
  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-64 bg-gradient-to-b from-[#1e1b4b] via-[#312e81] to-[#1e1b4b] text-white flex flex-col shadow-2xl z-50">
      ...
      <div className="p-6 border-b border-indigo-700/30">
        <Link to="/dashboard" className="flex items-center gap-3 group">
          ...
          <div>
            ...
            <p className="text-xs text-indigo-300 font-medium tracking-wide">Powertech SPA</p>
          </div>
        </Link>
      </div>
      ...
      <div className="px-4 py-3 border-b border-indigo-700/30">
        <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-white/5 hover:bg-white/10 transition-colors cursor-pointer">
          <div className="w-10 h-10 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-lg">
          ...
          <Bell size={16} className="text-indigo-300 hover:text-white transition-colors" />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto py-4 px-3 space-y-1 custom-scrollbar">
        {menuSections.map((section) => (
          <div key={section.id} className="mb-2">
            {/* Título de Sección */}
            {section.title && (
              <div className="px-4 py-2 text-[10px] font-bold text-indigo-400/70 uppercase tracking-widest mt-4 flex items-center gap-2">
                <div className="flex-1 h-px bg-indigo-700/30"></div>
                ...
                return (
                  <Link
                    ...
                    className={`
                      ...
                      ${active 
                        ? 'bg-gradient-to-r from-white to-blue-50 text-indigo-900 shadow-lg font-semibold scale-105' 
      ...
      <div className="border-t border-indigo-700/30 p-4 space-y-2 bg-gradient-to-t from-[#1e1b4b]/80 to-transparent">
        {/* Selector de Idioma con mejor diseño */}
        <div className="relative">
          <button
            onClick={() => toggleSection('language')}
            className="w-full flex items-center justify-between px-4 py-3 rounded-xl hover:bg-white/10 text-indigo-100 transition-all duration-200 group"
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-xs text-indigo-300">Idioma</p>
          ...
          >
            <div className="mt-2 ml-1 bg-indigo-950/50 rounded-xl overflow-hidden border border-indigo-700/30 backdrop-blur-sm">
              <button
